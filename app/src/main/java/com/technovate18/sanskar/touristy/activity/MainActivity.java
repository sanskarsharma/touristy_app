...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intesh = getIntent();
        if(intesh.getAction()!=null && intesh.getAction().equals(Constants.ACTION_OPEN_NOTIF_FRAGMENT)) {

            // for executing onNavigationItemSelected with our specified id
            navigationView.getMenu().performIdentifierAction(R.id.nav_notifications,0);
