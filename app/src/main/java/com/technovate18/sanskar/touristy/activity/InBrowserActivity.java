...
public class InBrowserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (WebView) findViewById(R.id.webView_in);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_in);
